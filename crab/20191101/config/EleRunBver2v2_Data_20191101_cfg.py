...
process.TFileService.fileName = cms.string("EleRunBver2v2_Data_20191101_Ntuple.root")
...
if isData:
    ...
    #for multi CRAB
    process.myMiniTreeProducer.MCTruth.sampleCode = cms.string("EleRunBver2v2")
