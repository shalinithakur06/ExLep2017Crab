...
process.TFileService.fileName = cms.string("ExLepEEZ_M3000_MC_20191101_Ntuple.root")
...
if isData:
    ...
    #for multi CRAB
    process.myMiniTreeProducer.MCTruth.sampleCode = cms.string("ExLepEEZ_M3000")
