...
process.TFileService.fileName = cms.string("DYJetsToLL_M50_MC_20191101_Ntuple.root")
...
if isData:
    ...
    #for multi CRAB
    process.myMiniTreeProducer.MCTruth.sampleCode = cms.string("DYJetsToLL_M50")
