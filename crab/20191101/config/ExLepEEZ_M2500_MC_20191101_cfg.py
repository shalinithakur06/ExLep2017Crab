...
process.TFileService.fileName = cms.string("ExLepEEZ_M2500_MC_20191101_Ntuple.root")
...
if isData:
    ...
    #for multi CRAB
    process.myMiniTreeProducer.MCTruth.sampleCode = cms.string("ExLepEEZ_M2500")
