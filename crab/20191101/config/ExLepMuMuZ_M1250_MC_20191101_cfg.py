...
process.TFileService.fileName = cms.string("ExLepMuMuZ_M1250_MC_20191101_Ntuple.root")
...
if isData:
    ...
    #for multi CRAB
    process.myMiniTreeProducer.MCTruth.sampleCode = cms.string("ExLepMuMuZ_M1250")
