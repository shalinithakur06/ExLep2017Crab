...
process.TFileService.fileName = cms.string("ExLepMuMuZ_M1000_MC_20191116_Ntuple.root")
...
if isData:
    ...
    #for multi CRAB
    process.myMiniTreeProducer.MCTruth.sampleCode = cms.string("ExLepMuMuZ_M1000")
