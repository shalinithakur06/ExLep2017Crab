...
process.TFileService.fileName = cms.string("ExLepEEZ_M1750_MC_20191116_Ntuple.root")
...
if isData:
    ...
    #for multi CRAB
    process.myMiniTreeProducer.MCTruth.sampleCode = cms.string("ExLepEEZ_M1750")
