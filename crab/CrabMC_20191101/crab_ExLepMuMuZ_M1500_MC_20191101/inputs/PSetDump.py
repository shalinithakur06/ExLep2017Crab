...
process.BaseJetsSet = cms.PSet(
    ...
    sources = cms.InputTag("slimmedJetsAK8")
)

process.BaseMCTruthSet = cms.PSet(
    isData = cms.bool(False),
    sampleCode = cms.string('ExLepMuMuZ_M1500')
)
...
process.BaseTriggerSet = cms.PSet(
    ...
    sourceFilter = cms.InputTag("TriggerResults","","HLT"),
    trigBits = cms.vstring(
        'HLT_IsoMu24', 
        'HLT_IsoTkMu24', 
        'HLT_Mu50', 
        'HLT_TkMu50', 
...
process.myMiniTreeProducer = cms.EDAnalyzer("MiniTreeProducer",
    ...
    minEventQualityToStore = cms.int32(1)
)
...
process.TFileService = cms.Service("TFileService",
    ...
    fileName = cms.string('ExLepMuMuZ_M1500_MC_20191101_Ntuple.root')
)
